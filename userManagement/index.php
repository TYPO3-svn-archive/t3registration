...
$LANG->includeLLFile('EXT:t3registration/userManagement/locallang.xml');
          ...
          switch((string)$this->MOD_SETTINGS['function'])	{
            case 1:
              $content='<div align="center"><strong>Hello World!</strong></div><br />
                The "Kickstarter" has made this module automatically, it contains a default framework for a backend module but apart from that it does nothing useful until you open the script '.substr(t3lib_extMgm::extPath('t3registration'),strlen(PATH_site)).'mod1/index.php and edit it!
                <hr />
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3registration/userManagement/index.php'])	{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3registration/userManagement/index.php']);
}
